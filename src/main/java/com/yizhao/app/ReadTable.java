...
public class ReadTable {
    public static void executeReadingArowByItsKeyMap(Table table, byte[] rowkey, byte[] COLUMN_FAMILY_NAME, byte[] COLUMN_NAME) throws Exception{
        ...
        System.out.println("valueBytes:" + data2);
